<template>
    <div class="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row mt-5">
        ...
        <router-link :to="{ name: 'cms.item.contact.index' }"
            class="btn btn-secondary ml-auto hover:ring-4">Quay lại</router-link>
        <!-- <a :href="this.baseURL + '/cms/item/contact'" class="btn btn-secondary ml-auto hover:ring-4">Quay lại</a> -->
                                        ...
                                        <div class="flex flex-wrap gap-4 list-size-design">
                                            <div class="w-full">
                                                <div class="input-form">
                                                    ...
                                                    <input v-model="form.email" name="email" id="email" maxlength="255" class="form-control" placeholder="Email">
                                                </div>
                                            </div>
                                            <div class="w-full">
                                                <div class="input-form">
                                                    <label for="title" class="form-label">Tiêu đề</label>
                                                    <input v-model="form.title" name="title" id="title" maxlength="255" class="form-control" placeholder="Title" >
                                                </div>
                                            </div>
                                            <div class="w-full">
                                                <div class="input-form">
                                                    <label for="content" class="form-label">Nội dung</label>
                                                    <textarea v-model="form.content" name="content" id="content" rows="5" placeholder="Nội dung" class="form-control" ></textarea>
                                                </div>
                                            </div>
                                            <div class="w-full">
                                                <div class="input-form">
...
export default {
    ...
    methods: {
        ...
        exit() {
            setTimeout(function () {
                window.location.href = `${that.baseURL}/cms/item/contact`
            }, 1000);
        },
        store(exit) {
            ...
            let that = this;
            axios
                .post(`${this.baseURL}/cms/api/item/contact`, this.form)
                .then((response) => {
